...
<div id="conteiner">
    <button onclick="getPedidoPizza();" class="btn btn-warning btn-lg" value="inserir" form="formPedido">Inserir item</button>
    <button type="button" onclick="window.location.href='classes/destroiSessao.php'" class="btn btn-warning btn-lg">Limpar</button>
    <button type="button" onclick="window.location.href='finalizaPedido.php'" class="btn btn-warning btn-lg">Salvar</button>
    ...
    <form id="formPedido" name="formPedido" method="post" action="pedidoPizza.php">
        <div class="panel panel-warning">
            ...
            <div class="panel-body">
                ...
                <div class="col-md-2">
                    <input class="form-control" type="text" id="txtTelefone" name="txtTelefone" placeholder="Telefone"/>
                </div>

                <div class="col-md-2">
                    <input class="form-control" type="text" id="txtCliente" name="txtCliente"  placeholder="Cliente"/>
                </div>

                <div class="col-md-3">
                    <input class="form-control" type="text" id="txtEndereco" name="txtEndereco" placeholder="Endereço"/>
                </div>
                ...
                <div class="col-md-2">
                    <input class="form-control"type="text" id="txtFuncionario" name="txtFuncionario" value ="1" placeholder="Funcionario"/>
                </div>
...
<div class="panel panel-warning">
    ...
    <div class="panel-body">
        <div class="row">
            ...
            <div class="col-md-3">
                <input class="form-control" type="text" id="txtDescricaoProduto" name="txtDescricaoProduto" placeholder="Descrição do Produto"/>
            </div>
            <div class="col-md-1">
...
if(($_SERVER['REQUEST_METHOD']=='POST')and($_POST['txtDescricaoProduto']!= null)){
    if(isset($_POST['txtDescricaoProduto'])and(empty($_SESSION['itensPedido'][0]))){
...
if(isset($_SESSION['dadosCliente'][0])and(isset($_SESSION['itensPedido'][0]))){
$valores = new Sessao();
echo"<h4>Cliente:</h4>";
